 ...
 * and set status to "live". Paths are relative to the site root.
 *
...
export const liveSimulations = () => SIMULATIONS.filter((s) => s.status === 'live');
