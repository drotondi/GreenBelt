...
(function (LSS) {
  ...
  function getLocale() { return LOCALES[current]; }
  ...
  function withLang(href, lang = current) {
  ...
  function setLang(lang) {
    ...
    try {
      ...
      /* history API unavailable (e.g. restricted file:// contexts): links still carry ?lang= */
    }
    syncDocument();
  ...
  LSS.i18n = {
    SUPPORTED_LANGS, DEFAULT_LANG, registerStrings, t, has, localize, getLang, getLocale,
    formatNumber, withLang, applyTranslations, updateLinks, onLangChange, setLang, initI18n,
  };
